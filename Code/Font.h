...
public:
	...
	void Draw(float x, float y, const wchar_t* string, size_t length, TEXT_ALIGN align = TEXT_ALIGN::UPPER_LEFT);
	void Draw(DirectX::XMFLOAT2 pos, const DirectX::XMFLOAT2 scale,const DirectX::XMFLOAT4 color, const wchar_t* string, size_t length, TEXT_ALIGN align = TEXT_ALIGN::UPPER_LEFT);
...
private:
	DirectX::XMFLOAT2 AdjustTextOrigin(TEXT_ALIGN align, DirectX::XMFLOAT2 pos, float width, float height);
